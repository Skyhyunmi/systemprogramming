...
#define IOCTL_MAGIC_NUMBER3          'l'
// #define IOCTL_SPI_SET_BIT_ORDER         _IOWR(IOCTL_MAGIC_NUMBER,0, int)
#define IOCTL_SPI_SET_CLOCK_DIVIDER     _IOWR(IOCTL_MAGIC_NUMBER3,0, int)
#define IOCTL_SPI_SET_DATA_MODE         _IOWR(IOCTL_MAGIC_NUMBER3,1, int)
/* Reads a single byte to SPI */
#define IOCTL_SPI_TRANSFER              _IOWR(IOCTL_MAGIC_NUMBER3,2, int)
/* Reads an number of bytes to SPI */
#define IOCTL_SPI_TRANSFER_NB           _IOWR(IOCTL_MAGIC_NUMBER3,3, int)
/* Reads an number of bytes to SPI */
#define IOCTL_SPI_WRITE_NB              _IOWR(IOCTL_MAGIC_NUMBER3,4, int)
#define IOCTL_SPI_TRANSFER_N            _IOWR(IOCTL_MAGIC_NUMBER3,5, int)
#define IOCTL_SPI_CHIP_SELECT           _IOWR(IOCTL_MAGIC_NUMBER3,6, int)
#define IOCTL_SPI_CHIP_SELECT_POLARITY  _IOWR(IOCTL_MAGIC_NUMBER3,7, int)
#define IOCTL_SPI_WRITE                 _IOWR(IOCTL_MAGIC_NUMBER3,8, int)
